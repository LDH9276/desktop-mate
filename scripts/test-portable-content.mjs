...
try{
  ...
  const report={result:'passed',version,executable,sha256:hash(executable),nativeBridgeMatched:true,visuals:{lighting:[0,1.5],brightness:[0,1.5],saturation:[0,2]},markdown:{heading:true,strong:true,table:true,code:true}};
